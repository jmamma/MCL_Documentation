...
\begin{figure}
    \centering
    \includegraphics[scale=0.7]{save_or_load_grid_a.png}
    \caption{Save Page / Load Page - Grid A - MD }
    \label{fig:my_label}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[scale=0.7]{save_or_load_grid_b.png}
    \caption{Save Page / Load Page - Grid B - External MIDI}
    \label{fig:my_label}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[scale=0.7]{save_or_load_grid_b_md.png}
