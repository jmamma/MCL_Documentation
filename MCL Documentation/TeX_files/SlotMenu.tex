...
%\fbox{\includegraphics[scale=.40]{slot_menu.png}}\\
\\
...
A rectangular selection consisting of multiple slots can be made by entering the slot menu and rotating \textbf{[Encoder 3]} and \textbf{[Encoder 4]}.
...
Grid: {[} A, B {]}                     & switch between Grid A or B.                                                      \\ \hline
