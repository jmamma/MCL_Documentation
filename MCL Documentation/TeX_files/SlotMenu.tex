...
\end{tabular}
\\\\\\
\textit{The \textbf{INSERT} row option of the Grid Page's slot menu will insert N blank rows in both Grid X and Y by shifting rows beneath. Note: the Grid length is never increased and the last N rows at end of the Grid will be deleted.}